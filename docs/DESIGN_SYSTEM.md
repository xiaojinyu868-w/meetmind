...
> 本文是 MeetMind 视觉体系的唯一文字真相源，从 AGENTS.md 迁出（2026-07-28 wiki 化）。
> 可视化 showcase 在 `design-demo/v7/`（9 篇 HTML：foundations / AI 视觉 / 组件 / 应用矩阵 / 课中 / 复习 / 分享落地 / 移动端 / 暗色 + `tokens.css` + `index.html` 导航页）。
