...
```mermaid
flowchart LR
    A["真实学习现场<br/>课堂 · 视频 · 文章 · 图片 · 想法"] --> B["个人学习上下文<br/>内容 · 目标 · 标记 · 反馈"]
    B --> C["当下最需要的动作<br/>解释 · 定位 · 复述 · 检验"]
    C --> D["继续积累<br/>下一节课不再从零开始"]
    C --> E["分享场景上下文<br/>让同学接着问、接着学"]
```
...
### 6. 分享的不只是文件，而是一段可以继续对话的上下文

一节课的场景上下文可以变成 Shared Agent。

同学在班级群里打开分享链接后，不只能看一张静态笔记，还可以围绕那节课继续提问、领取到自己的学习工作台，并在自己的空间里继续做练习。
...
| 回答看起来正确，但出处不清楚 | 时间戳和来源引用可以回到真实原件 |
