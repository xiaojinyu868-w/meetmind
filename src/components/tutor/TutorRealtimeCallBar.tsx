        ...
        <button
          ...
          className={`relative flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full border transition-colors disabled:cursor-not-allowed disabled:opacity-40 ${
            isActive
              ...
              : 'border-[#D9D8D3] bg-white text-[#232322]'
          }`}
        ...
        >
          <div className="flex items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <span className={`truncate text-[15px] font-medium ${isActive ? 'text-[#232322]' : 'text-[#787774]'}`}>
                {copy.title}
              </span>
            </div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <MessageCircle size={12} strokeWidth={1.8} className="flex-shrink-0 text-[#A3A39E]" />
            <p className="truncate text-xs text-[#787774]">{copy.body}</p>
          </div>
        </button>
      </div>
    </div>
