...
├── MathText.tsx                 # 牌面 / 短文本里的 $…$ 行内公式渲染（切分在 lib/utils/math-text.ts，与 teach-live 字幕 / 提问卡 / 课堂记录及朗读转换共用；2026-09-11 起也认没写 $ 的裸 LaTeX、不再把 $5 当公式；公式段先过 expandColorMacros——课堂色板宏 \pine{} 等在任何窗口里都渲成对应颜色而不是 KaTeX 报错）
