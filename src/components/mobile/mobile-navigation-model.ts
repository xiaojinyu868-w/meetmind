export type MobileScreen = 'home' | 'recording' | 'processing' | 'review' | 'flashcards' | 'quiz' | 'cheatsheet' | 'mindmap' | 'audio-overview' | 'infographic' | 'teach-back' | 'explainer' | 'apps' | 'classmate' | 'echo' | 'empty';
