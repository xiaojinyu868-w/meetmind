...
// 哲学：描述场景，不规定字数 / 段落 / 步骤。
// 学生选中一个词需要解释——交给模型自己判断"该说多少话最合适"。
const EXPLAIN_SYSTEM_PROMPT = `学生正在看课堂转录，圈出了一个词或一段话问你。你和他一起刚听完这节课，所以你能看到这个词在课堂上下文里的具体语境。用最自然的口气帮他理解——他问的就是这一段语境下的这个词，不是抽象定义，不要堆教科书式的解释。`;
