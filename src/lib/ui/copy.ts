...
export const COPY = {
  ...
  recording: {
    ...
    /** 录课中要离开课堂布局 / 这个页面（2026-09-11）：一句确认，离开 = 录到这里的内容先收好、这节课留成"没结束" */
    leaveConfirm: '正在录课。离开会先把录到这里的内容收好，这节课留成「没结束」，回到课堂可以继续录或就到这里。',
    /** 访客录完课（2026-09-11）：一句安静的入口，不弹窗 */
    guestSync: {
      line: '登录后，这节课会跟着你到任何设备',
      action: '登录',
    },
    ...
    unfinished: {
      ...
      /** 录音引擎随布局卸载被打断（2026-09-11）：录到这里的内容已落盘，回到课堂由恢复条接手 */
      interrupted: '录音停在这里了，回到课堂可以继续录或就到这里',
      /** 课堂列表里没结束那张卡的状态字 */
      cardStatus: '还没结束',
    },
