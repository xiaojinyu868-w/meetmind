...
export const APPS_COPY = {
    ...
    teachBack: {
      ...
      evidenceLabel: '课堂依据',
      startVoice: '开始讲',
      voiceHint: '麦克风常开。你讲，他们听；你停下来，才有人开口。',
      textTitle: '把这节课讲给同桌',
      ...
      reviewNext: (point: string): string => `接下来先把「${point}」说一遍。`,
      reviewSteadyNone: '再讲一遍，我接着听。',
      reviewUncoveredLead: '你没讲到：',
      reviewUncoveredNone: '要讲的都讲到了。',
      reteachUnclear: '只讲没讲清的',
    },
    mindmap: {
      appName: '思维导图',
    ...
    explainer: {
      ...
      /** 控制条（2026-09-10）：上一步 / 下一步按讲解段走；空格 / ←→ 键盘 */
      prevStep: '上一步',
      nextStep: '下一步',
      stepLabel: (current: number, total: number): string => `第 ${current} / ${total} 步`,
      speed: (speed: number): string => `语速 ${speed}x`,
      stepDisabledHint: '先回答黑板上的问题，再往下走',
      inkDisabledHint: '回答完这个问题再板演',
      keyboardHint: '空格 播放 / 暂停 · ←→ 上一步 / 下一步',
      checkpointKnow: '我会了',
      checkpointHint: '给我提示',
