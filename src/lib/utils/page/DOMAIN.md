...
| `capture-source-utils.ts` | 366 | Capture/Source：mergeWorkspaceCaptures, buildWorkspaceCaptureSourceItem, buildWechatCaptureSourceItem |
| `context-and-format.ts` | 368 | ASR/Tutor 上下文 + 视频洞察 + formatTime + transcribeAudioFile/parseDocumentFile/parseImageFile |
