...
export const metadata: Metadata = {
  ...
  title: `${COPY.identity.productName} - ${LANDING_COPY.landing.hero.eyebrow}`,
  description: LANDING_COPY.landing.hero.body,
  openGraph: {
    title: `${COPY.identity.productName} - ${LANDING_COPY.landing.hero.eyebrow}`,
    description: LANDING_COPY.landing.hero.body,
    type: 'website',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: LANDING_COPY.landing.hero.title.replaceAll('\n', ' '),
    }],
  },
  twitter: {
