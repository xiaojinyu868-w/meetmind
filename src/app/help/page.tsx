...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '截图收集怎么用？',
        answer: '任何时候按 Ctrl/Cmd + Shift + M，会把鼠标所在屏幕截下来：\n\n- 正在录课时按：当前画面作为关键帧挂到这节课的时间轴上，课后笔记里能看到\n- 没录课时按：截图收进收集流，MeetMind 会识别图中的文字\n\n截图成功的瞬间，桌宠会做一个吞食的小动作。小窗（Cmd/Ctrl + Shift + K 唤起）里也有截图按钮，效果一样。\n\n网络不好时截图会先存在本地，下次启动自动补传，不会丢。'
      },
      {
        question: '有哪些全局热键？',
        answer: '在任何应用里都能用：\n\n- Cmd/Ctrl + Shift + K：唤起/收起随手问小窗（失焦会自动收起）\n- Cmd/Ctrl + Shift + M：截取鼠标所在屏幕（录课中挂课堂时间轴，平时进收集流）\n\n托盘菜单里也能随时查看热键说明、开关开机自启。'
      },
      {
        question: '桌面端会自动更新吗？',
